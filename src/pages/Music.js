...
function Mobile(){
    ...
    return(
<div className='column' style={{alignItems: "center",  backgroundColor: 'white' }}>
    <div style={{padding:'15px 15px 15px 15px'}}></div> 
     <a href="https://ffm.to/en-tu-alma" target="_blank" className='row' style={{width: "100vw", justifyContent: "center"}}><img src={EnTuAlma} style={{width: "95%"}}/></a>
    ...
    <div style={{padding:'15px'}}></div>
    <a href="https://ffm.to/like-a-weirdo" target="_blank" className='row' style={{width: "100vw", justifyContent: "center"}}><img src={LikeAWeirdo} style={{width: "95%"}}/></a>
    <div style={{padding:'15px'}}></div> 
    ...
    <div style={{padding:'15px'}}></div> 
    <a href="https://ffm.to/super-human" target="_blank" className='row' style={{width: "100vw", justifyContent: "center"}}><img src={Superhuman} style={{width: "95%"}}/></a>
    <div style={{padding:'15px'}}></div> 
        <a href="https://ffm.to/super-human" target="_blank"><button className="share-button" style={{width: "115px", height: "40px"}}>Share</button></a> 
         <MailchimpForm/>
        <Footer/>
    </div>
    )
